...
public class ParentResource {
    ...
    /**
     * POST  /parents : Create a new human.
     *
    ...
    public ResponseEntity<Human> createHuman(@RequestBody Human human) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/parents/" + result.getId()))
                .headers(HeaderUtil.createEntityCreationAlert(ENTITY_NAME, result.getId()))
                .body(result);
    }

    /**
     * PUT  /parents : Updates an existing human.
     *
    ...
    /**
     * GET  /parents : get all the humans.
     *
    ...
    /**
     * GET  /parents/:id : get the "id" human.
     *
    ...
    /**
     * DELETE  /parents/:id : delete the "id" human.
     *
